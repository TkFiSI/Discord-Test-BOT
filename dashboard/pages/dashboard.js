  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold text-white">Server-Übersicht</h1>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <input
                  ...
                  className="bg-gray-700 text-white px-4 py-2 pl-10 rounded-lg border border-gray-600 focus:outline-none focus:border-blue-500 w-64"
                />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-white mb-2">Deine Server</h2>
          <p className="text-gray-300">Verwalte deine Discord Server mit professionellen Tools</p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">{guilds?.length || 0}</h3>
                <p className="text-gray-400">Gesamte Server</p>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Aktiv</h3>
