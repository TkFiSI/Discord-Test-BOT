    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4 py-2">
        ...
        {filteredGuilds?.length === 0 ? (
          ...
          <div className="grid grid-cols-6 md:grid-cols-10 lg:grid-cols-12 xl:grid-cols-16 gap-1">
            {filteredGuilds?.map((guild) => (
              <div key={guild.id} className="card hover:scale-105 transition-all duration-300 p-1">
                <div className="flex flex-col items-center text-center">
                  {/* Server Icon */}
                  <div className="w-3 h-3 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center mb-1 shadow-lg">
                    {guild.icon ? (
                      <img 
                  ...
                  <a 
                    href={`/guild/${guild.id}`}
                    className="btn-primary w-full flex items-center justify-center py-0.5 px-0.5 text-xs"
                  >
