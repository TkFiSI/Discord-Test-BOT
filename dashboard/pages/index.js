        ...
        <div className="text-center max-w-4xl mx-auto fade-in">
          ...
          <div className="mb-8">
            <img 
              ...
              className="w-32 h-32 mx-auto mb-6 rounded-2xl shadow-2xl transform hover:scale-110 transition-transform duration-300"
            />
          </div>
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Professionelle Server-Verwaltung mit modernsten Features und intuitivem Interface
          </p>

          {!session && (
            <div className="space-y-6">
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
                <h2 className="text-2xl font-semibold text-white mb-4">Willkommen zurück!</h2>
                <p className="text-gray-300 mb-6">
                  Melde dich mit Discord an, um deine Server zu verwalten und alle Einstellungen anzupassen.
                </p>
                <button
                  onClick={() => signIn('discord')}
                  onMouseEnter={() => setIsHovered(true)}
                  onMouseLeave={() => setIsHovered(false)}
                  className="btn-primary w-full sm:w-auto px-8 py-4 text-lg font-semibold flex items-center justify-center gap-3 mx-auto"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <div className="card">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Auto-Moderation</h3>
                  <p className="text-gray-400 text-sm">Intelligente Moderation mit KI und anpassbaren Regeln</p>
                </div>
                ...
                <div className="card">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Welcome System</h3>
                  <p className="text-gray-400 text-sm">Automatische Begrüßung und Rollenvergabe</p>
                </div>
                ...
                <div className="card">
                  ...
                  <p className="text-gray-400 text-sm">Detaillierte Statistiken und Einblicke</p>
                </div>
              </div>
            </div>
          )}
              ...
              <div className="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Bereit deine Server zu verwalten?</p>
                  </div>
                </div>
